...
package dbms_project.excel_input_0_1;
...
/**
 * Job: excel_input Purpose: get_files_fron_excel<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class excel_input implements TalendJob {
	...
	private final String jobName = "excel_input";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(excel_input.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_DBMS_PROJECT_excel_input = new byte[0];
		static byte[] commonByteArray_DBMS_PROJECT_excel_input = new byte[0];

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_DBMS_PROJECT_excel_input) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				globalMap.put("ENABLE_TRACES_CONNECTION_tFileInputExcel_1", Boolean.FALSE);
...
///////////////////////    			
				...
				Object source_tFileInputExcel_1 = "C:/Users/Mega-PC/Desktop/Bi_project/Data_Guide.xls";
				...
				try {
					...
					if (sheetList_tFileInputExcel_1.size() > 0) {
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							row1 = null;
							int tempRowLength_tFileInputExcel_1 = 0;
...
//end%>
							...
							if (row1 != null) {
								globalMap.put("ENABLE_TRACES_CONNECTION_tFileInputExcel_1", Boolean.TRUE);
								if (runTrace.isPause()) {
									...
									runTrace.sendTrace("row1", "tFileInputExcel_1", runTraceData);
								}
...
///////////////////////    			
							...
							if (!isChildJob && (Boolean) globalMap.get("ENABLE_TRACES_CONNECTION_tFileInputExcel_1")) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final excel_input excel_inputClass = new excel_input();

		int exitCode = excel_inputClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = excel_input.class.getClassLoader()
					.getResourceAsStream("dbms_project/excel_input_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = excel_input.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : excel_input");
		}
...
/************************************************************************************************
 * 42177 characters generated by Talend Open Studio for Data Integration on the
 * January 19, 2024, 2:09:22 AM CET
 ************************************************************************************************/