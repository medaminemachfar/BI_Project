...
public class test implements TalendJob {
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_DBMS_PROJECT_test = new byte[0];
		static byte[] commonByteArray_DBMS_PROJECT_test = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DBMS_PROJECT_test.length) {
					if (length < 1024 && commonByteArray_DBMS_PROJECT_test.length == 0) {
						commonByteArray_DBMS_PROJECT_test = new byte[1024];
					} else {
						commonByteArray_DBMS_PROJECT_test = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DBMS_PROJECT_test, 0, length);
				strReturn = new String(commonByteArray_DBMS_PROJECT_test, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_DBMS_PROJECT_test, 0, length);
				strReturn = new String(commonByteArray_DBMS_PROJECT_test, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DBMS_PROJECT_test) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String fileName_tFileOutputExcel_1 = "C:/Users/Mega-PC/Desktop/Bi_project/out.xlsx";
				...
				if (xlsxTool_tFileOutputExcel_1.getStartRow() == 0) {
					...
					xlsxTool_tFileOutputExcel_1.addCellValue("code");
				...
				sbHeader_tLogRow_1.append("label");
...
///////////////////////    			
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:hXBxCAdNsDTMZ7HPlB41FxTcGFtEoSYidIMb5A==");
				...
				Object source_tFileInputExcel_1 = "C:/Users/Mega-PC/Desktop/Split_document/Data_Guide_1_Police Force.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.code = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "label";

									row1.label = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.label = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
...
///////////////////////		
								...
								if (row1.label != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(row1.label));
...
///////////////////////    			
								...
								if (row2.code != null) {
									...
									xlsxTool_tFileOutputExcel_1
											.addCellValue(Double.parseDouble(String.valueOf(row2.code)));
								} else {
								...
								if (row2.label != null) {
									...
									xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row2.label));
								} else {
									xlsxTool_tFileOutputExcel_1.addCellNullValue();
								}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = test.class.getClassLoader()
					.getResourceAsStream("dbms_project/test_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 63078 characters generated by Talend Open Studio for Data Integration on the
 * January 20, 2024, 12:09:42 AM CET
 ************************************************************************************************/